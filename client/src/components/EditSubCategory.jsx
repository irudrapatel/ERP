...
const EditSubCategory = ({ close, data, fetchData }) => {
    const [subCategoryData, setSubCategoryData] = useState({
        ...
        code: data.code || "" // Added code field here
    });
        ...
        <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800 bg-opacity-70 z-50 flex items-center justify-center p-4'>
            <div className='w-full max-w-5xl bg-white p-4 rounded'>
                <div className='flex items-center justify-between gap-3'>
                    <h1 className='font-semibold'>Edit Part Details</h1>
                ...
                <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='border focus-within:border-primary-200 rounded'>
                            ...
                            >
                                <option value={""}>Select Camera Category</option>
                                {
                    ...
                    <button
                        ...
                        className={`px-4 py-2 border
                            ${subCategoryData.name && subCategoryData.image && subCategoryData.category.length && subCategoryData.code ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-200"}    
                            font-semibold
                        `}
                    >
                        Submit
